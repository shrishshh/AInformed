...
9. `PERPLEXITY_API_KEY`: Your Perplexity API key (for AI/tech news search)
10. `CRON_SECRET`: A secure random string for authenticating cron job requests (used by `/api/cron/tavily`)
